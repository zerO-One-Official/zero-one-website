...
const options = [
  {
    title: <>What is Zero-one ?</>,
    body: (
      <>
        Zero-one Coding Club is the Official Coding Club of Motihari College of
        Engineering, Motihari. It works as an open-source organization. Members
        here learn and collaborate to make their ideas into a solution/product.
        It also organizes hackathons driven by the idea of making proof of
        concepts of great ideas using software.
      </>
    ),
  },
  {
    title: <>Where does Zero-one operate from ?</>,
    body: (
      <>
        In college, Zero-one operates from Dept. of CSE & AI, Motihari College
        of Engineering, Motihari Bihar - 845401, now it is in operation via
        remote only
      </>
    ),
  },
    ...
    body: (
      <>
        ...
        <ul className="pl-8">
          ...
          <li>
            Be patient. You have to prove your willingness to join Zero-one. We
            will test this quality by rejecting you if you fall short in your
            domain. You have to improve and apply again. We want genuine people
            who show interest as well as do some actual work to get inducted.
          </li>
        ...
        <ul>
          ...
          <li>
            Learn digital art from the guidance of current Zero-one members and
  ...
  {
    title: <>What are some of the domains of Zero-one ?</>,
    body: (
      <>
        The domains of Zero-one are:-
        <ul>
  ...
  },
  {
    title: (
      <>
        What tasks do I need to do to land an interview for Zero-one Coding
        Club?
      </>
    ),
    body: (
      <>
        ...
        <ul>
          <li>
            Get in touch with a member of Zero-one and ask him/her to refer you.
          ...
          <li>
            ...
            Codechef Monthly Long Challenge 4 months from joining College or 2
          ...
          <li>
            ...
            of Zero-one). In such a scenario Management has more weightage.
          </li>
          <li>Have any prior experience with Robots or Arduino.</li>
          <li>
            Miscellaneous i.e. Show us any skill that you might think Zero-one
  ...
  },
  {
    title: (
      <>
        ...
        i.e. Zero-One. What should I do now ?
      </>
    ),
    body: (
      <>
  ...
  {
    title: (
      <>I am not from a CS Branch. Is Zero-one the right choice for me ?</>
    ),
    body: (
      <>
        There is <strong>“NO BRANCH RESTRICTION”</strong>, we have more than 60%
        of members, who are from non-CS branch, If you are interested in any one
        of our segments, then definitely you should apply.
      </>
    ),
  },
  {
  ...
  {
    title: <>Is Zero-one an open club ?</>,
    body: (
      <>
        ...
        etc. , Zero-one got you covered.
        <br />
        There are some organizations/clubs you can be in along with Zero-one
        are:-
        <ul>
          <li>Arts Club</li>
          <li>Sports Club</li>
  ...
  {
    title: <>Can a Non-MCEian become a member of Zero-one ?</>,
    body: (
      <>
        Zero-one is working towards making the community diverse and strong. We
        are going to come up with this idea very soon. Right now we are working
        towards the structure of Zero-one when Non-MCEian can join.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <br />
        In Zero-one we use Unity as it is good for beginners and small
        developers. YouTube has tons of tutorials regarding Unity Game
        Development and Unity itself has Demo Games and Tutorials for learning
  ...
  {
    title: <>I don’t have a laptop. I am eligible to join Zero-one ?</>,
    body: (
      <>
        ...
        Yes, you need a laptop to survive in Zero-one or else you will not be
        able to take the benefit of the community that Zero-one offers.
      </>
    ),
  },
  {
  ...
  {
    title: <>I want someone to mentor me. Can Zero-one help me ?</>,
    body: (
      <>
        <Link href="/teams">
          Zero-one Team Page
  ...
  {
    title: <>How big is Zero-one?</>,
    body: (
      <>
        <strong>This much 🤏!!!</strong> Just kidding.
        <br />
        In terms of a team, we are being led by our seniors along with students
        from all the years.
        <br />
        The final year members bepost-bearers and the third year are the post
        bearers of the club. Generally, each year consists of 4-8 members, it
        can be more or less.
        <br />
  ...
  },
  {
    ...
    body: (
      <ul>
        <li>Hackathon (ZO-Thon)</li>
        <li>Winter Of Code</li>
        <li>Zero-One Storm</li>
        <li>Let`&#39;`s Code (Monthly Coding Contest)</li>
        <li>HacktoberFest</li>
      </ul>
    ),
  },
  {
    title: <>What are some of the achievements of Zero-one ?</>,
    body: (
      <>
        <ul>
          <li>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Non vero
            nobis minus earum animi corporis aliquam voluptates explicabo alias
            itaque.
          </li>
          <li>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Non vero
  ...
  {
    title: <>What is Linux ? Why do Zero-one members suggest Linux ?</>,
    body: (
      <>
        ...
        <br />
        <br />
        <strong>Long Answer</strong>:- Zero-one Members will always suggest you
        go for the open-source operating system Linux. Linux powers the
        internet, system administrators, Supercomputers etc.
        <br />
        ...
        <br />
        You can read more about the experience of having Linux OS, on our blog
        <a href="#" target="_blank" rel="noreferrer">
          Developer Docs
        </a>
      </>
  ...
  },
  {
    title: (
      <>
        What are some of the projects deployed by Zero-one and can be seen by
        users ?
      </>
    ),
    body: (
      <>
        ...
        <ul>
          ...
          <li>
            <a href="#" target="_blank" rel="noreferrer">
              Zero-one Contest Site
            </a>
          </li>
          <li>
            <a href="#" target="_blank" rel="noreferrer">
              Zero-one Learn Website
            </a>
          </li>
        </ul>
      </>
  ...
  {
    title: <>What are the social handles of Zero-one ?</>,
    body: (
      <>
        <a href="#" target="_blank" rel="noreferrer">
          Discord
  ...
  {
    title: <>We are an organization and we want to collab with Zero-one.</>,
    body: (
      <>
        Email us at
        <a href="mailto:zerooneofficial.ce@gmail.com">
