export const JoiningEmailTemplate = (joiningLink) => {
															...
															<td class="pad">
																<div
																	...
																	<p style="margin: 0; margin-bottom: 16px;">We are
																		...
																		One Coding Club! 🌟👩‍💻<br /><br />Your passion
...
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:42px;width:98px;v-text-anchor:middle;" arcsize="48%" stroke="false" fillcolor="#ffffff">
<w:anchorlock/>
