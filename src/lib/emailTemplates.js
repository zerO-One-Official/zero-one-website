                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    ...
                                                                    <div style="max-width: 500px;"><img
                                                                            src="${baseUrl}/congratulation.png"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
                                                                            width="500" /></div>
                                                                </div>
                                                            </td>
...
export const contactEmail = ({ name, roll, email, message }) => {
    return `<!DOCTYPE html>
                                                                ...
                                                                <td class="pad"
                                                                    ...
                                                                    <div align="center" class="alignment"
                                                                        ...
                                                                        <div style="max-width: 204px;">
                                                                            <a href="https://zero-one-mce.vercel.app/"
                                                                                style="outline:none" tabindex="-1"
                                                                                target="_blank">
                                                                                <img src="${baseUrl}/fullLogo.png"
                                                                                    style="display: block; height: auto; border: 0; width: 100%;"
                                                                                    width="204" />
                                                                            </a>
                                                                        </div>
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td class="pad"
                                                                    ...
                                                                    <div
                                                                        style="color:#ffffff;direction:ltr;font-family:'Poppins', Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:left;mso-line-height-alt:24px;">
                                                                        <h1 style="margin: 0; margin-bottom: 16px;">
                                                                            ${name}
                                                                            <br>
                                                                            <span style="font-size: 12px;color: #979797; font-weight: 400;">
                                                                                ${email}
                                                                            </span>
                                                                        </h1>
                                                                        <h2 style="margin: 0; margin-bottom: 16px; font-weight:500">
                                                                            Roll No.: ${roll}
                                                                        </h2>
