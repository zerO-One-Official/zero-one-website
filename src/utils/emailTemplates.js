...
export const infoEmail = (heading, message) => {
  return `<!DOCTYPE html>
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td class="pad"
                                                                    ...
                                                                    <div align="center" class="alignment"
                                                                        style="line-height:10px">
                                                                        <div style="max-width: 500px;style="color:#ffffff;font-weight: 500;font-family:'Poppins'">
                                                                            <h1 style="color:#ffffff;font-weight: 500;font-family:'Poppins'">${heading}</h1>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td class="pad"
                                                                    ...
                                                                    <div
                                                                        style="color:#ffffff;direction:ltr;font-family:'Poppins';font-size:16px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:left;mso-line-height-alt:24px;">
                                                                            <p style="margin: 0; margin-bottom: 16px; font-family:'Poppins';">${message}</p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
...
const ig = ` <!--[if (mso)|(IE)]><td width="32" style="width:32px; padding-right: 12px;" valign="top"><![endif]-->
                                                                    <table align="center" border="0" cellspacing="0"
                                                                        cellpadding="0" width="32" height="32"
                                                                        style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 12px">
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="center" valign="middle"
                                                                                    style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                                    <a href="https://instagram.com/zeroonemce"
                                                                                        title="Instagram"
                                                                                        target="_blank">
