          ...
          path === '/login'
            ...
            data && data.user ?
              <div className="xs:w-screen w-96 p-2">
                ...
                <div className="w-full shadow-cus border border-l-white/5 border-t-white/5 border-r-black/25 border-b-black/25 rounded-3xl flex flex-col gap-4 items-center p-4">
                  ...
                  <div className="flex xs:flex-col gap-1 w-full">
                    <Link
                      href={`/user/${data.user.username}`} onClick={unmount} className='flex-1 bg-white/5 p-2 py-3 flex justify-center rounded-l-2xl xs:rounded-2xl hover:bg-white/10 transition-all items-center'>Profile</Link>
                    <button onClick={signOut} className='flex-1 bg-red-500 p-2 py-3 flex justify-center  rounded-r-2xl xs:rounded-2xl hover:bg-red-600 transition-all items-center'>Logout</button>
                  </div>
                </div>
              </div>
              :
